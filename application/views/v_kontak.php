...
<html class="no-js">
	...
	<meta name="author" content="Hashfi Ihkamuddin" />
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Mr.Ineffable<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jalan Pahlawan, Bogor selatan, Kota Bogor 16131</li>
						<li><i class="icon-phone"></i>+62 815 1748 6650</li>
						<li><i class="icon-envelope"></i><a href="#">hashfi0000000@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="#">mrineffable.github.io</a></li>
					</ul>
				</div>
