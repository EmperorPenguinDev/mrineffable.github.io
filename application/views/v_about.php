		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> Awesome source code by Hashfi Ihkamuddin</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Hashfi Ihkamuddin</h3>
						<h4>Co-Founder, CEO</h4>
						<p>Hashfi Ihkamuddin adalah seorang programmer lulusan SMK di kota Bogor.</p>
