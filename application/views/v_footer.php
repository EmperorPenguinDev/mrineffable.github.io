<footer id="fh5co-footer" role="contentinfo">
		...
		<div class="container">
			<div class="col-md-3 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
				<h3>About Us</h3>
				<p>Mr.Ineffable merupakan perusahaan yang bergerak dan memfokuskan diri pada bidang Konsultan IT dan Security.</p>
			</div>
			...
			<div class="col-md-12 fh5co-copyright text-center">
				<p>&copy;<a id="year" style="text-decoration: None; color: gray;"></a> by <a style="text-decoration: None;">Hashfi Ihkamuddin</a>. All Rights Reserved.</p>
			</div>
